...
namespace FuelStationWebApi.Data
{
    ...
    {
        public static void Initialize(TVShowsContext db)
        {
            ...
            //    db.Genres.Add(new Genre { NameGenre = fuelType, FuelDensity = fuelDensity });
            //}
            ////сохранение изменений в базу данных, связанную с объектом контекста
            //db.SaveChanges();
            ...
            //    db.TVShows.Add(new TVShow { TankID = tankID, GenreID = fuelID, NameShow = inc_exp, Date = operationdate });
            //}
            ////сохранение изменений в базу данных, связанную с объектом контекста
            //db.SaveChanges();
        }
